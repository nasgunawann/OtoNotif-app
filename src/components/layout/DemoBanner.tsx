...
export function DemoBanner() {
  ...
  return (
    <div className="bg-amber-200 dark:bg-amber-950 border-b border-amber-200 dark:border-amber-800 px-3 py-2 text-center text-xs sm:text-sm">
      <span className="text-amber-800 dark:text-amber-200">
        Anda sedang di mode demo. Data akan hilang saat keluar dari aplikasi ini.
      </span>
